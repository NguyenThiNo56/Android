...
public class ViDu_ListView_Hardcode_Array extends Activity {
	protected void onCreate(Bundle savedInstanceState) {
		 super.onCreate(savedInstanceState);
		 setContentView(R.layout.activity_vi_du__list_view__hardcode__array);
		 ...
		 final TextView txt=(TextView) findViewById(R.id.textselection);
